...
import "./Edit_subdepartment.css";
import Topright from "../../Components/Top_right/Top_right";

function Edit_subdepartment() {
    return(
        <div className="editSubdepartment_body">
            <div className="container">
                <div className="Topright pt-5">
                    <Topright/>
                    <h2 className="fw-bold fs-4 mb-1 mt-4 pt-4 " style={{ color: "#434343" }}>
                    Sub Department summary - Sub Department 1
                    </h2>
                </div>
                                ...
                                <div className="container">
                                    <div className="row">
                                        ...
                                        <div className="input-group form-dark mb-3 justify-content-between">
                                            <input type="text" id="typeEmailX" className="form-control form-control-md" placeholder="Sub Department 1" />
                                        </div>
...
export default Edit_subdepartment;