...
import "./Create_sector.css";
// import { MDBBtn } from 'mdb-react-ui-kit';  
// import AddOutlinedIcon from '@mui/icons-material/AddOutlined';

function Create_sector() {
    return(
        <section className="createsector-body vh-100">
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="input-group form-dark mb-3 justify-content-between">
                            <input type="text" id="typeEmailX" className="form-control form-control-md" placeholder="Sector Name" />
                        </div>
