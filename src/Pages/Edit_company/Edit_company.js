                                ...
                                <div className="container">
                                    <div className="row">
                                        ...
                                        <div className="input-group form-dark mb-3 justify-content-between">
                                            <input type="text" id="typeEmailX" className="form-control form-control-md" placeholder="Company 1" />
                                        </div>
