...
import "./Create_organization.css";
// import { MDBBtn } from 'mdb-react-ui-kit';  
// import AddOutlinedIcon from '@mui/icons-material/AddOutlined';

function Create_organization() {
    return(
        <section className="createorganization-body vh-100">
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="input-group form-dark mb-3 justify-content-between">
                            <input type="text" id="typeEmailX" className="form-control form-control-md" placeholder="Organiation Name" />
                        </div>
